...
//cors middleware
const whitelist = ['https://ts-prog-frontend.trafficmanager.net/', 'https://ts-prog-frontend.trafficmanager.net/', 'http://localhost:3000', 'http://localhost:3200', 'https://ts-prog.herokuapp.com', 'https://ts-prog1.herokuapp.com/'];
const corsOptions = {
