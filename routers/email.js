...
email_router.get('/send', checkAuthenticated, (req, res) => {
    ...
    email.save().then((res_mongo) => {
        const mailOptions = {
            ...
            html: `<html><h2>Verify Account For Ts-Prog</h2><br><a href='https://ts-prog1.herokuapp.com/email-back/callback/${res_mongo._id}'>https://ts-prog.herokuapp.com/email-back/callback/${res_mongo._id}</a></html>`
        };
